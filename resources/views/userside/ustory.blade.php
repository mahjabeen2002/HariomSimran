...
@section("title")
<head>
<title>Story | HariomSimran</title>
    ...
    <div class="sigma_subheader-inner">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Stories->Category</li>
        </ol>
      </nav>
    </div>
  </div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="schedule-box maxwidth500 bg-light mb-30">
           <div class="schedule-details clearfix p-15 pt-10">
              <h5 class="font-16 title"><a href="#" style="cursor:auto">No Stories Found</a></h5>
             </div>
          </div>
        </div>
       @endif
