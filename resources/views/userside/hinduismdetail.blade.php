...
<?php
    ...
    $pdes = strip_tags($fetchmediade->description);
    ?>
    <title> {{$fetchmediade->title}}</title>
<meta name="description" content="{{$pdes}}" />
<meta property="og:image" content="http://hariomsimran.com/hinduismimages/{{$fetchmediade->image}}" />
<meta property="og:url" content="http://hariomsimran.com/hinduismdetail/{{$ptitle}}/{{$fetchmediade->id}}" />
<meta property="og:category_id" content="website" /> 
    ...
    <div class="sigma_subheader-inner">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Hindusim</li>
        </ol>
      </nav>
    </div>
  </div>
  ...
  <div class="container">
    <div class="section-content">
      <div class="row">
        <div class="col-md-4">
          <div class="thumb">
            <img src="{{ asset('/uploads/hinduism/'.$fetchmediade->image) }}" alt="" width="300px" height="300px">
          </div>
          <br>
          <ul>
            <h3>Share On:</h3>
          ...
          <?php
                                ...
                                $url = urlencode("http://hariomsimran.com/hinduismdetail/$ptitle/$fetchmediade->id");
        ...
        <div class="col-md-8">
          ...
          $pv = DB::table('categories')->where('id',$fetchmediade->category_id)->first();
          ?>
          <h5 class="mt-5">Category : {{$pv->title}}</h5> 
          <p>{!! html_entity_decode($fetchmediade->description) !!}.</p>
