...
<?php
    ...
    $pdes = strip_tags($fetchdetail->des);
    ?>
    ...
    <div class="sigma_subheader-inner">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">HariOm Simran</li>
        </ol>
      </nav>
    </div>
  </div>
  ...
  <div class="container">
    <div class="section-content">
      <div class="row">
        <div class="col-md-4">
          <div class="thumb">
            <img src="/cartimages/{{$fetchdetail->image}}" alt="" width="300px" height="300px">
          </div> <br>
          <ul>
            <h3>Share On:</h3>
          <?php
                                $url = urlencode("http://hariomsimran.com/hariomsimran/$ptitle/$fetchdetail->id");
        ...
        <div class="col-md-8">
          ...
          <p>{!! html_entity_decode($fetchdetail->des) !!}.</p>
