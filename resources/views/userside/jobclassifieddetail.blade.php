...
<meta property="og:image" content="http://hariomsimran.com/uploads/jobclassified/{{$fetch->image}}" />
<meta property="og:url" content="http://hariomsimran.com/jobclassifieddetail/{{$fetch->slug}}" />
  ...
  <div class="container">
    <div class="section-content">
      <div class="row">
        <div class="col-md-4">
          <div class="thumb">
            <img src="{{ asset('/uploads/jobclassified/' . $fetch->image) }}" alt="" width="300px" height="300px">
          </div> <br>
          <ul>
            <h3>Share On:</h3>
          <?php
                                $url = urlencode("http://hariomsimran.com/jobclassifieddetail/$fetch->slug");
