    ...
    <div class="col-12 col-md-6 order-md-2 order-first">
        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">DailyQuiz Leader Board Table</li>
            </ol>
        </nav>
    </div>
</div>
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $leaderboard->dailyquiz ? $leaderboard->dailyquiz->question_name : 'No associated test' }}</td>
                            <td>{{ $leaderboard->marks_obtained }}</td>
                            <td>{{ $leaderboard->total_marks }}</td>
                            <td>{{ $leaderboard->remarks }}</td>
                            <td>
                                <div style="display: flex; align-items: center;">
                                    <a href="{{ route('admin-dailyquizleaderboarddelete', ['id' => $leaderboard->id]) }}" onclick="confirmation(event)" style="margin-right: 10px;">
