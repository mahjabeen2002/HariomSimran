      ...
      <div class="card">
          ...
          <div class="">
              <a href="{{ route('subject-create') }}" class="btn btn-success"
                  style="float: right; margin-top: -51px; margin-right: 41px;">Add Subject</a>
                      ...
                      <tbody>
                        @foreach($subjects as $subject)
                              <tr>
                                <td>{{ $subject->id }}</td>
                                <td>{{ $subject->name }}</td>
                                <td>{{ $subject->department->depart_name }}</td>
                                  ...
                                  <td>
                                      <div style="display: flex; align-items: center;">
                                          ...
                                          <a href="{{ route('subject-edit', ['id' => $subject->id]) }}"><i
...
function confirmation(ev) {
  ...
  swal({
          title: "Are you want to Delete Subject",
