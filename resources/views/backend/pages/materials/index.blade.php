          ...
          <div class="col-12 col-md-6 order-md-2 order-first">
              <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Materail Table</li>
                  </ol>
              </nav>
          </div>
      </div>
      ...
      <div class="card">
          ...
          <div class="">
              <a href="{{ route('material-create') }}" class="btn btn-success"
                  style="float: right; margin-top: -51px; margin-right: 41px;">Add Material</a>
          ...
          <div class="card-body" style="overflow-x: auto;">
              <div class="table-responsive" style="max-height: 400px;">
                  <table class="table table-striped" id="table1">
                      ...
                      <tbody>
                        @foreach($materails as $materails)
                              <tr>
                                  <td>{{ $materails->title }}</td>
                                  <td>{{ $materails->description }}</td>
                                  <td>
                                    <a href="{{ route('material-download', ['id' => $materails->id]) }}" target="_blank">
                                        {{ $materails->file }}
                                    </a>
                                </td>
