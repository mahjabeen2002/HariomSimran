        ...
        <div class="page-heading">
                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Collaboration Table</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <section class="section">
                <div class="card">
                    ...
                    <div class="">
                        <a href="{{ route('collaboration-create') }}" class="btn btn-success"
                            style="float: right; margin-top: -51px; margin-right: 41px;">Add Collaboration</a>
                            ...
                            <table class="table table-striped" id="table1">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Collaboration Title</th>
                                ...
                                <tbody>
                                    @foreach ($collaboration as $collaboration)
                                        <tr>
                                            ...
                                            <td>{{ $collaboration->status == '1' ? 'Hidden' : 'Visible' }}</td>
                                            <td><img style="height:50px; width:50px;"
                                                    src="{{ asset('/uploads/collaboration/' . $collaboration->image) }}"
                                                    alt=""></td>
                                            <td>
                                                <div style="display: flex; align-items: center;">
                                                    <a href="{{ route('collaboration-delete', ['id' => $collaboration->id]) }}"
                                                        onclick="confirmation(event)" style="margin-right: 10px;"><i
                                                            class="bi bi-trash" style="color: red;font-size:20px"></i></a>
                                                    <a href="{{ route('collaboration-edit', ['id' => $collaboration->id]) }}"><i
