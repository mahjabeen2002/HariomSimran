                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Announcement Table</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="">
                        <a href="{{ route('announcement-create') }}" class="btn btn-success"
                            style="float: right; margin-top: -51px; margin-right: 41px;">Add Announcement</a>
                                ...
                                <tbody>
                                    @foreach ($announcement as $announcement)
                                        <tr>
                                            ...
                                            <td>{{ $announcement->status == '1' ? 'Hidden' : 'Visible' }}</td>
                                            <td><img style="height:50px; width:50px;"
                                                    src="{{ asset('/uploads/announcement/' . $announcement->image) }}"
                                                    alt=""></td>
                                            <td>
                                                <div style="display: flex; align-items: center;">
                                                    ...
                                                    <a href="{{ route('announcement-edit', ['id' => $announcement->id]) }}"><i
