                ...
                <div class="col-md-12 col-12">
                  <div class="card">
                    ...
                    <div class="card-content">
                      <div class="card-body">
                        <form class="form form-vertical" action="{{ route('announcement-update', $announcement->id) }}" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date" placeholder="date" value="{{ $announcement->date }}" />
                                        @error('date')
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="editor">{{ $announcement->description }}</div>
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <img style="height:50px; width:50px;" src="{{asset('/uploads/announcement/'.$announcement->image)}}" alt="">
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="videourl" placeholder="Video Url"value="{{$announcement->videourl}}" />
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="meta_title" value="{{$announcement->meta_title}}" class="form-control">
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="meta_keyword" value="{{$announcement->meta_keyword}}" class="form-control">
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="meta_description_editor">{{ $announcement->meta_description }}</div>
