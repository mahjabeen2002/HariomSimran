            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3> Course Test Question & Option Table</h3>
                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Course Test Question & Option Table</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        Course Test  Question & Option Table
                    </div>
                    <div class="">
                        <a href="{{ route('coursetestquestion-create') }}" class="btn btn-success"
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    @foreach ($questions as $question)
                                        <tr>
                                            <td>{{ $question->id }}</td>
                                            <td>{{ $question->lecture_id }}</td>
                                            <?php
                                            $test = DB::table('lectures')
                                                ->where('id', $question->lecture_id)
                                                ->first();
                                            //$subject = DB::table('subjects')->where('id',$test->subject_id)->first();
                                            $option = DB::table('coursequiz_options')
                                            ...
                                            <td>
                                                <div style="display: flex; align-items: center;">
                                                    <a href="{{ route('coursetestquestion-delete', ['id' => $question->id]) }}"
                                                        onclick="confirmation(event)" style="margin-right: 10px;"><i
                                                            class="bi bi-trash" style="color: red;font-size:20px"></i></a>
                                                    <a href="{{ route('coursetestquestion-edit', ['id' => $question->id]) }}"><i
