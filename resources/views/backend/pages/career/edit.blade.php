                              ...
                              <div class="row">
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="editor">{{ $career->description }}</div>
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <img style="height:50px; width:50px;" src="{{asset('/uploads/career/'.$career->image)}}" alt="">
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="meta_title" value="{{$career->meta_title}}" class="form-control">
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="meta_keyword"
                                           value="{{$career->meta_keyword}}" class="form-control">
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="meta_description_editor">{{ $career->meta_description }}</div>
