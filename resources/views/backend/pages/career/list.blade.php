                ...
                <div class="card">
                    ...
                    <div class="">
                        <a href="{{ route('career-create') }}" class="btn btn-success"
                            style="float: right; margin-top: -51px; margin-right: 41px;">Add career</a>
                                ...
                                <tbody>
                                    @foreach ($career as $career)
                                        <tr>
                                            ...
                                            <td>{{ $career->status == '1' ? 'Hidden' : 'Visible' }}</td>
                                          
  <td><img style="height:50px; width:50px;"
                                                    src="{{ asset('/uploads/career/' . $career->image) }}"
                                                    alt=""></td>
                                            <td>
                                                <div style="display: flex; align-items: center;">
                                                    <a href="{{ route('career-delete', ['id' => $career->id]) }}"
                                                        onclick="confirmation(event)" style="margin-right: 10px;"><i
                                                            class="bi bi-trash" style="color: red;font-size:20px"></i></a>
                                                    <a href="{{ route('career-edit', ['id' => $career->id]) }}"><i
