                ...
                <div class="col-md-12 col-12">
                  <div class="card">
                    ...
                    <div class="card-content">
                      <div class="card-body">
                        <form class="form form-vertical" action="{{ route('article-update', $article->id) }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-body">
                              <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                      <label for="tittle">Article Posted By</label>
                                      <fieldset class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date" placeholder="date" value="{{ $article->date }}" />
                                        @error('date')
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="editor">{{ $article->description }}</div>
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <img style="height:50px; width:50px;" src="{{asset('/uploads/article/'.$article->image)}}" alt="">
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="videourl" placeholder="Video Url"value="{{$article->videourl}}" />
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="meta_keyword" value="{{$article->meta_keyword}}" class="form-control">
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="meta_description_editor">{{ $article->meta_description }}</div>
