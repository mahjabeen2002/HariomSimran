                ...
                <div class="col-md-12 col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title"> Edit Katha </h4>
                    </div>
                    <div class="card-content">
                      <div class="card-body">
                        <form class="form form-vertical" action="{{ route('katha-update', $katha->id) }}" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="row">
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="title" class="form-control" value="{{$katha->title}}">
                                        ...
                                        <fieldset class="form-group">
                                            <select class="form-select" id="basicSelect" name="category_id">
                                                @foreach ($category as $cat)
                                                    <option value="{{ $cat->id }}" {{ $cat->id == $katha->category_id ? 'selected' : '' }}>
                                                        {{ $cat->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="editor">{{ $katha->description }}</div>
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <img style="height:50px; width:50px;" src="{{asset('/uploads/katha/'.$katha->image)}}" alt="">
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="meta_title" value="{{$katha->meta_title}}" class="form-control">
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="meta_keyword" value="{{$katha->meta_keyword}}" class="form-control">
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="meta_description_editor">{{ $katha->meta_description }}</div>
