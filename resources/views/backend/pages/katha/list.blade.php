        ...
        <div class="page-heading">
                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Katha Table</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <section class="section">
                <div class="card">
                    ...
                    <div class="">
                        <a href="{{ route('katha-create') }}" class="btn btn-success"
                            style="float: right; margin-top: -51px; margin-right: 41px;">Add Katha</a>
                            ...
                            <table class="table table-striped" id="table1">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Katha ID</th>
                                        <th scope="col">Katha Title</th>
                                ...
                                <tbody>
                                    @foreach ($katha as $katha)
                                        <tr>
                                            <td>{{ $katha->id }}</td>
                                            <td>{{ $katha->title }}</td>

                                            <td>{{ $katha->description }}</td>
                                            <td>{{ $katha->status == '1' ? 'Hidden' : 'Visible' }}</td>
                                            <td><img style="height:50px; width:50px;"
                                                    src="{{ asset('/uploads/katha/' . $katha->image) }}"
                                                    alt=""></td>
                                            <td>
                                                <div style="display: flex; align-items: center;">
                                                    <a href="{{ route('katha-delete', ['id' => $katha->id]) }}"
                                                        onclick="confirmation(event)" style="margin-right: 10px;"><i
                                                            class="bi bi-trash" style="color: red;font-size:20px"></i></a>
                                                    <a href="{{ route('katha-edit', ['id' => $katha->id]) }}"><i
