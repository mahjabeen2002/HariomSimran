                ...
                <div class="card">
                    ...
                    <div class="">
                        <a href="{{ route('team-create') }}" class="btn btn-success"
                            style="float: right; margin-top: -51px; margin-right: 41px;">Add team</a>
