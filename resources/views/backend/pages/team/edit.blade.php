                        ...
                        <form class="form form-vertical" action="{{ route('team-update', $team->id) }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-body">
                              <div class="row">
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                      <label for="tittle">Designation</label>
                                      <input type="text" class="form-control" name="designation" placeholder="designation" value="{{$team->designation}}" />
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="editor">{{ $team->description }}</div>
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <img style="height:50px; width:50px;" src="{{asset('/uploads/team/'.$team->image)}}" alt="">
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="meta_title" value="{{$team->meta_title}}" class="form-control">
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="meta_keyword" value="{{$team->meta_keyword}}" class="form-control">
                                  ...
                                  <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="meta_description_editor">{{ $team->meta_description }}</div>
