                                ...
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-xl">
                                        ...
                                        <?php 
                                            ...
                                            ?>
                                        <img src="{{ asset('uploads/Students/' . $users->profile_image) }}" type="image/png" alt="Face 1">
                                    </div>
                                    <div class="ms-3 name">
                                    ...
                                    <div class="ms-auto">
                                        <div class="dropdown">
                                            <button  class=" dropdown-toggle"  type="button" id="profileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="profileDropdown">
                                                <!-- Dropdown items -->
                                                <a class="dropdown-item" href="/youraccount">Account Setting</a>
                                                <a class="dropdown-item" href="/changepasswordget">Change Password</a>
